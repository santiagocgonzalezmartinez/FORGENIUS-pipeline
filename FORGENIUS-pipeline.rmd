---
title: "FORGENIUS-pipeline, Aalba target"
author: "SCGM & MW"
date: "`r Sys.Date()`"
...
```{r read data}
data_vcf <- read.vcfR("data/Aalba_target_SNP_sampleFilt.vcf.gz") #change species name
...
basemap(xlim, ylim) 
shape <- read.shapefile("shapefiles/chorological_maps_dataset/Abies_alba_syn_plg_clip") #change species name, need to add Europe's coast line...
