...
species_name = "Aalba_SNP_sampleFilt_random" #change species name
...
struct2geno (input.file="snmf/data_structure", ploidy=2, FORMAT=2, extra.row=0, extra.column=1) #writting this file can take quite long
